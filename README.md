...
| [IP Restriction](https://github.com/DaryaServer/xui/#enable-ip-restrictions-per-inbound) | :heavy_check_mark: |
| [Inbound Multi User](https://github.com/DaryaServer/xui/#enable-multi-user-traffic--exprire-day) | :heavy_check_mark: |
| [Multi User Traffic & expire day](https://github.com/DaryaServer/xui/#enable-multi-user-traffic--exprire-day) | :heavy_check_mark: |
| [REST API](https://github.com/DaryaServer/xui/pull/51) | :heavy_check_mark: |
| [Telegram BOT](https://github.com/DaryaServer/xui/pull/110) | :heavy_check_mark: |
...
```
bash <(curl -Ls https://raw.githubusercontent.com/DaryaServer/xui/master/install.sh)
```

## Manual install & upgrade

1. First download the latest compressed package from https://github.com/DaryaServer/xui/releases , generally choose Architecture `amd64`
...
> This docker tutorial and docker image are provided by [DaryaServer](https://github.com/DaryaServer)
...
[![Stargazers over time](https://starchart.cc/DaryaServer/xui.svg)](https://starchart.cc/DaryaServer/xui)
